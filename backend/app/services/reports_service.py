...
def render_pdf_report(report_id: str, competitor_name: str, markdown_content: str) -> str:
    ...
    pdf.cell(0, 12, f"Competitive Intelligence Report", new_x="LMARGIN", new_y="NEXT")
    pdf.set_font("Helvetica", "", 13)
    pdf.set_text_color(100, 116, 139)  # Slate
    pdf.cell(0, 8, competitor_name, new_x="LMARGIN", new_y="NEXT")
    pdf.ln(2)
    ...
    for line in lines:
        ...
        # Strip bold markdown markers for PDF rendering
    ...
    pdf.cell(
        0, 5,
        f"Generated by Autonomous Competitive Intelligence Agent Network  |  {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}",
        align="C",
    )
