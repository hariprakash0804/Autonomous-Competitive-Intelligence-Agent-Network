    ...
    <div className="min-h-screen mesh-gradient-bg flex items-center justify-center p-4 relative overflow-hidden noise-overlay">
      ...
      <div className="w-full max-w-md relative z-10 animate-spring-in">
        ...
        <div className="text-center mb-8 animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl glass glow mb-4 signal-pulse transition-transform duration-300 hover:scale-105 hover:rotate-3 border border-indigo-500/20">
        ...
        {/* Login/Signup Card */}
        <div className="glass-card rounded-2xl p-8 neon-border shadow-2xl animate-scale-in" style={{ animationDelay: '100ms' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 px-4 btn-gradient rounded-xl text-sm transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg shadow-indigo-600/20"
            >
              {isLoading ? (
        ...
        {/* Trust Indicators */}
        <div className="mt-6 flex items-center justify-center gap-6 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
          {[
