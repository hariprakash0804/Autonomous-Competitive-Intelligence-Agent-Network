          ...
          <div className="px-6 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div>
                ...
                <p className="text-[10px] text-slate-500">Manage your identity and competitor tracking targets</p>
              </div>
            </div>
              ...
              <div className="lg:col-span-1 space-y-6 stagger-item" style={{ '--i': 0 }}>
                <div className="glass-card rounded-2xl p-6 space-y-5 neon-border">
                    ...
                    <div
                      className={`p-3 rounded-xl text-xs flex items-center gap-2 animate-scale-in ${
                        profileMsg.type === 'success'
                          ...
                          : 'bg-rose-500/10 border border-rose-500/15 text-rose-300'
                      }`}
                    >
                  ...
                  <form onSubmit={handleProfileSubmit} className="space-y-4 text-xs">
                    ...
                    <div>
                      <label className="block text-slate-400 font-semibold mb-1.5 flex items-center gap-1 text-[10px] uppercase tracking-wider">
                        <Globe className="w-3 h-3 text-slate-500" /> Company URL
                      </label>
                      <input
                        type="url"
                        value={companyUrl}
                    ...
                    <button
                      ...
                      className="w-full mt-2 btn-gradient py-2.5 rounded-xl flex items-center justify-center gap-2 transition disabled:opacity-50 text-xs"
                    >
                        ...
                        <tbody className="divide-y divide-white/[0.03]">
                          {(Array.isArray(filteredCompetitors) ? filteredCompetitors : []).map((c, idx) => (
                            ...
                            >
                              ...
                              <td className="py-3.5 px-3 font-mono text-slate-400 max-w-[200px] truncate text-[11px]">
                                {c.pricing_url ? (
                                  <a href={c.pricing_url} target="_blank" rel="noreferrer" className="hover:underline text-indigo-400 hover:text-indigo-300 transition-colors">
                                    {c.pricing_url}
                                  </a>
                                ) : (
                              ...
                              <td className="py-3.5 px-3">
                                <span className="bg-white/[0.04] text-slate-300 px-2.5 py-1 rounded-lg font-mono font-semibold text-[11px]">
                                  {c.snapshot_count || 0}
                                </span>
                              </td>
                              ...
                              <td className="py-3.5 px-3 text-right">
                                <div className="flex items-center justify-end gap-1">
                                  <button
                                    ...
                                    className="p-2 bg-indigo-500/10 hover:bg-indigo-600 text-indigo-400 hover:text-white rounded-lg transition-all duration-200 hover:scale-110"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="p-2 bg-white/[0.03] hover:bg-white/[0.08] text-slate-400 hover:text-white rounded-lg transition-all duration-200 hover:scale-110"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="p-2 bg-rose-500/10 hover:bg-rose-600 text-rose-400 hover:text-white rounded-lg transition-all duration-200 hover:scale-110"
                                  >
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="glass-card rounded-2xl max-w-md w-full p-6 neon-border shadow-2xl space-y-4 animate-spring-in">
            <div className="flex items-center justify-between border-b border-white/[0.04] pb-3">
              <h3 className="text-sm font-bold text-white flex items-center gap-2 font-display">
                <Edit2 className="w-4 h-4 text-indigo-400" /> Edit Competitor Target
              </h3>
          ...
          <div className="glass-card rounded-2xl max-w-md w-full p-6 neon-border shadow-2xl space-y-4 animate-spring-in">
            ...
            <form onSubmit={handleAddSubmit} className="space-y-3 text-xs">
              ...
              <div>
                ...
                <input type="url" value={addCompanyUrl} onChange={(e) => setAddCompanyUrl(e.target.value)} placeholder="https://mycompany.com"
                  className="w-full bg-white/[0.03] rounded-xl px-3.5 py-2.5 text-slate-100 placeholder-slate-600 input-glow transition-all duration-300" />
              </div>
              <div>
